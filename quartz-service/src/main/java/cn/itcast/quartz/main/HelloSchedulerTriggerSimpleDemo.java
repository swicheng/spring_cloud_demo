...
import cn.itcast.quartz.job.HelloJobSimpleTrigger;
import org.quartz.*;
...
public class HelloSchedulerTriggerSimpleDemo {
    ...
    public static void main(String[] args) throws SchedulerException {
       ...
       Trigger trigger = TriggerBuilder.newTrigger()
             ...
             //  .startNow()
               .startAt(new Date())
               .withSchedule(SimpleScheduleBuilder.repeatSecondlyForever(5).withRepeatCount(3)) //五秒后重复执行 重复三次
                .build();
